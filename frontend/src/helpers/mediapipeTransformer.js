/* global VideoFrame */
import VonageDrawingUtils from 'utils/DrawingUtilsHelper'

class MediapipeTransformer {
   
    mediapipePorcess_ = null
    mediapipeResult_ = null
    mediapipeConsts_ = null
    mediapipeSelfieResult_ = null
    ...
    drawFaceDetaction(){
        let results = this.mediapipeResult_ 
